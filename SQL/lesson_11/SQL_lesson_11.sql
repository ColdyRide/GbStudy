...
FOR EACH ROW BEGIN 
    INSERT INTO logs (ext_id,table_name,item_name) VALUES (NEW.id,'users',NEW.name);
END//

DROP TRIGGER IF EXISTS products_insert//
CREATE TRIGGER products_insert AFTER INSERT ON products 
FOR EACH ROW BEGIN 
    INSERT INTO logs (ext_id,table_name,item_name) VALUES (NEW.id,'products',NEW.name);
END//

DROP TRIGGER IF EXISTS catalogs_insert//
CREATE TRIGGER catalogs_insert AFTER INSERT ON catalogs 
FOR EACH ROW BEGIN 
    INSERT INTO logs (ext_id,table_name,item_name) VALUES (NEW.id,'catalogs',NEW.name);
END//
delimiter ;
