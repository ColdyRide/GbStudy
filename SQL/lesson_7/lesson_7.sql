...
SELECT products.name AS 'Product name', catalogs.name AS 'Catalog name' FROM products
JOIN catalogs
...
c2.name AS 'To'
FROM cities AS c1
RIGHT JOIN flights AS f1 ON f1.`from` = c1.label
LEFT JOIN cities AS c2 ON f1.`to` = c2.label;
